              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">@lhuizf</p>
                  </div>
                </a>
                <a
                  href="https://www.linkedin.com/in/luizhenrique-ferreira/"
                  target="_blank"
                  className="flex items-center gap-3 px-4 py-3 bg-gray-800/50 rounded-lg hover:bg-gray-700/50 transition-colors border border-gray-700/50 group"
                >
                  <div className="p-2 bg-gray-700/50 rounded-lg group-hover:bg-gray-600/50 transition-colors">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">@lhuizy</p>
                  </div>
                </a>
                <a
                  href="https://open.spotify.com/user/22ivfqe3qknnlkzzc7ae43ecq?si=b053c8ef52864f97&nd=1&dlsi=9c02dbf023b64e57"
                  target="_blank"
                  className="flex items-center gap-3 px-4 py-3 bg-gray-800/50 rounded-lg hover:bg-gray-700/50 transition-colors border border-gray-700/50 group"
                >
                  <div className="p-2 bg-gray-700/50 rounded-lg group-hover:bg-gray-600/50 transition-colors">
